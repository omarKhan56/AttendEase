...
// The AuthContext provides the authenticated user's information, which is essential for fetching and displaying the correct attendance history based on the user's role.
  ...
  const fetchHistory = async () => {
    ...
    try {
      ...
      const url = selectedClass
        ? `${import.meta.env.VITE_API_URL}/attendance/history?classId=${selectedClass}&page=${page}&limit=10`
        : `${import.meta.env.VITE_API_URL}/attendance/history?page=${page}&limit=10`;
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden">
          ...
          <div className="flex items-center justify-center gap-4 py-6 bg-gray-50">
